...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ConcurrentLinkedQueue<Transaction> transactionsFromOtherNodesAndWallet = new ConcurrentLinkedQueue<>();
        ConcurrentLinkedQueue<Block> blocksToNode = new ConcurrentLinkedQueue<Block>();
        Ledger.getInstance();
        Thread node = new Thread(new Node(transactionsToMiners, blocksToNode, transactionsFromOtherNodesAndWallet));
        ...
        Thread wallet = new Thread(new Wallet(transactionsFromOtherNodesAndWallet));
